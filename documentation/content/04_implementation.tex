...
\begin{figure}
	...
	\begin{minipage}{.5\textwidth}
		...
		\label{fig:mob_calc2}
	\end{minipage}
	\captionof{figure}{Mobility Index values in different time windows (left) and fragment of duration values (in seconds) over which mobility index has been calculated (right) - window of 30 minutes}
\end{figure}
